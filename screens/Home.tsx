...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <Button title="Delete All Transactions" onPress={deleteAllTransactions} />
...
function TransactionSummary({
  ...
  const getMoneyTextStyle = (value: number) => ({
    fontWeight: "bold",
  ...
  return (
    <Card style={styles.container}>
      <Text style={styles.summaryText}>
        Income: <Text>{formatMoney(totalIncome)}</Text>
      </Text>
      <Text style={styles.summaryText}>
        Expenses: <Text>{formatMoney(totalExpenses)}</Text>
      </Text>
      <Text style={styles.summaryText}>
        Savings: <Text>{formatMoney(savings)}</Text>
      </Text>
    </Card>
  );
}
